...
const CardNav: React.FC<CardNavProps> = ({
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Hide on scroll down (only if scrolled past threshold)
  ...
  return (
    <div
      ...
      className={`card-nav-container absolute left-1/2 -translate-x-1/2 w-[90%] max-w-[800px] z-[99] transition-transform duration-300 ease-out ${
        isVisible ? "top-[1.2em] md:top-[2em]" : "-translate-y-full"
      } ${className}`}
    >
      <nav
        ref={navRef}
