  ...
  "text-muted-foreground flex h-auto cursor-text select-none items-center justify-center gap-2 py-1 text-sm font-medium group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-[calc(var(--radius)-5px)] [&>svg:not([class*='size-'])]:size-4",
  {
    variants: {
      align: {
        ...
        "block-start":
          "[.border-b]:pb-2 order-first w-full justify-start px-3 pt-2 group-has-[>input]/input-group:pt-2",
        "block-end":
          "[.border-t]:pt-2 order-last w-full justify-start px-3 pb-2 group-has-[>input]/input-group:pb-2",
      },
    },
    defaultVariants: {
      align: "inline-start",
